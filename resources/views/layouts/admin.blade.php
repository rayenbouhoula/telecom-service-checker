    ...
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand d-flex align-items-center" href="{{ route('admin.dashboard') }}">
                @if($logoExists)
                    <img src="{{ asset('images/tunisie-telecom-logo.png') }}" alt="Tunisie Telecom" height="40"
                        class="me-2">
                @else
    ...
    <nav class="sidebar col-md-3 col-lg-2 d-md-block">
        <div class="position-sticky">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.service-availability.*') ? 'active' : '' }}"
                        href="{{ route('admin.service-availability.index') }}">
                        <i class="bi bi-broadcast-pin"></i> Service Availability
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.areas.*') ? 'active' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.status-history.*') ? 'active' : '' }}"
                        href="{{ route('admin.status-history.index') }}">

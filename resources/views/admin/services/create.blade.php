                ...
                <form action="{{ route('admin.services.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex gap-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input @error('status') is-invalid @enderror" type="radio" name="status" id="status_unavailable" value="unavailable" {{ old('status') == 'unavailable' ? 'checked' : '' }}>

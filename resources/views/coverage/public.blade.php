        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div id="coverage-checker" class="space-y-6">
                ...
                <div id="results" class="hidden">
                    <div class="bg-gradient-to-r from-tt-blue-light to-white rounded-xl p-6 border-l-4 border-tt-blue">
                ...
                result.data.forEach(item => {
                    ...
                    historyItem.innerHTML = `
                        <div class="flex items-center space-x-4">
                            <div class="w-10 h-10 bg-tt-blue-light rounded-full flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <span class="ml-3 px-2 py-1 bg-tt-blue-light text-tt-blue rounded text-sm font-medium">${item.coverage_data.network_type}</span>
                            </div>
                        </div>
